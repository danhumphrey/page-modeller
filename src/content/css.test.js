...
describe('idBuilder', () => {
  ...
  test('css selector for element with id', () => {
    ...
    expect(idBuilder(element)).toBe(`[id='forename']`);
  });
  ...
  test('css selector for multiple elements with duplicate id', () => {
    ...
    expect(idBuilder(element1)).toBe(`[id='surname']:nth-of-type(1)`);
    expect(idBuilder(element2)).toBe(`[id='surname']:nth-of-type(2)`);
  });
});
...
describe('nameBuilder', () => {
  ...
  test('css selector for element with name', () => {
    ...
    expect(nameBuilder(element)).toBe(`[name='forename']`);
  });
  ...
  test('css selector for multiple elements with duplicate name', () => {
    ...
    const element2 = document.getElementsByClassName('second')[0];
    expect(nameBuilder(element1)).toBe(`[name='surname']:nth-of-type(1)`);
    expect(nameBuilder(element2)).toBe(`[name='surname']:nth-of-type(2)`);
  });
});
...
describe('ariaLabelBuilder', () => {
  ...
  test('css selector for element with aria-label', () => {
    ...
    expect(ariaLabelBuilder(element)).toBe(`[aria-label='The Forename']`);
  });
  ...
  test('css selector for multiple elements with duplicate name', () => {
    ...
    const element2 = document.getElementsByClassName('second')[0];
    expect(ariaLabelBuilder(element1)).toBe(`[aria-label='Something']:nth-of-type(1)`);
    expect(ariaLabelBuilder(element2)).toBe(`[aria-label='Something']:nth-of-type(2)`);
  });
});
...
describe('imageBuilder', () => {
  ...
  test('IMG element with alt attribute returns correct css selector', () => {
    ...
    const element = document.querySelector(`img`);
    expect(imageBuilder(element)).toBe(`[alt='Test']`);
  });
  ...
  test('css selector for multiple elements with matching alt attribute', () => {
    ...
    const element2 = document.getElementsByClassName('second')[0];
    expect(imageBuilder(element1)).toBe(`[alt='Test']:nth-of-type(1)`);
    expect(imageBuilder(element2)).toBe(`[alt='Test']:nth-of-type(2)`);
  });

  test('IMG element with title attribute returns correct css selector', () => {
    document.body.innerHTML = '<img title="Profile"/>';
    const element = document.querySelector(`img`);
    expect(imageBuilder(element)).toBe(`[title='Profile']`);
  });
  ...
  test('css selector for multiple elements with matching title attribute', () => {
    ...
    const element1 = document.querySelector(`img`);
    const element2 = document.getElementsByClassName('second')[0];
    expect(imageBuilder(element1)).toBe(`[title='Test']:nth-of-type(1)`);
    expect(imageBuilder(element2)).toBe(`[title='Test']:nth-of-type(2)`);
  });
  ...
  test('IMG element with relative src attribute returns correct css selector', () => {
    ...
    const element = document.querySelector(`img`);
    expect(imageBuilder(element)).toBe(`[src*='images/kittens.png']`);
  });
  ...
  test('css selector for multiple elements with matching src attribute', () => {
    ...
    const element1 = document.querySelector(`img`);
    const element2 = document.getElementsByClassName('second')[0];
    expect(imageBuilder(element1)).toBe(`[src*='puppy.png']:nth-of-type(1)`);
    expect(imageBuilder(element2)).toBe(`[src*='puppy.png']:nth-of-type(2)`);
  });
});
...
describe('relativeCssBuilder', () => {
  ...
  test('parent element with id returns correct css selector', () => {
    ...
    const element = document.querySelector('p');
    expect(relativeCssBuilder(element)).toBe(`[id='parent'] > p`);
  });
  ...
  test('ancestor element with id returns correct css selector', () => {
    ...
    const element = document.querySelector('p');
    expect(relativeCssBuilder(element)).toBe(`[id='ancestor'] > div > p`);
  });
  ...
  test('ancestor element with multiple children returns correct css selector', () => {
    ...
    const element = document.querySelector('p');
    expect(relativeCssBuilder(element)).toBe(`[id='ancestor'] > div:nth-of-type(2) > p`);
  });
  ...
  test('relative locator from parent with multiple siblings returns correct css selector', () => {
    ...
    expect(relativeCssBuilder(element1)).toBe(`[id='parent'] > p:nth-of-type(1)`);
    expect(relativeCssBuilder(element2)).toBe(`[id='parent'] > p:nth-of-type(2)`);
  });
});
...
describe('getCssSelector', () => {
  ...
  test('element which matches preferred selector', () => {
    ...
    expect(getCssSelector(element)).toBe(`[id='contact-link']`);
  });

  test('element which matches relative selector', () => {
    document.body.innerHTML = '<div id="parent"><p>Paragraph</p></div>';
    const element = document.querySelector('p');
    expect(getCssSelector(element)).toBe(`[id='parent'] > p`);
  });
